...
const Character: React.FC = () => {
    ...
    const saveCharacter = async (formState: any) => {
        if (id?.startsWith('local-')) {
            ...
            try {
                const response = await instance.post(url, { body: JSON.stringify(formState) });
                ...
                <>
                    <div className="container mx-auto p-8 bg-black/50 rounded-lg sm:col-span-2">
                        <header className="mb-6 text-center">
                            ...
                            <button onClick={handleEditClick} className='bg-gray-500/50 p-2 rounded-xl'>Edit</button>
                        </header>
